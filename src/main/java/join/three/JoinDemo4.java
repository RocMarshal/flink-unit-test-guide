...
public class JoinDemo4 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //将城市流定义为广播流
    final MapStateDescriptor<Integer, String> broadcastDesc =
        new MapStateDescriptor("broad1", Integer.class, String.class);
    ...
    DataStream result = textStream.connect(broadcastStream)
        .process(
            new BroadcastProcessFunction<Tuple2<String, Integer>, Tuple2<Integer, String>, Tuple3<String, Integer, String>>() {
              //处理非广播流，关联维度
              @Override
