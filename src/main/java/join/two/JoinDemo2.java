...
import org.apache.flink.shaded.curator4.com.google.common.cache.CacheBuilder;
import org.apache.flink.shaded.curator4.com.google.common.cache.CacheLoader;
import org.apache.flink.shaded.curator4.com.google.common.cache.LoadingCache;
import org.apache.flink.shaded.curator4.com.google.common.cache.RemovalListener;
import org.apache.flink.shaded.curator4.com.google.common.cache.RemovalNotification;
 ...
 * 实时流在关联维表数据的时候实时去外部存储中查询，这种方式特点如下：
 *
